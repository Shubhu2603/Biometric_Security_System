...
public class FaceDetector implements Runnable {
					...
					if (grabbedImage != null) {
						...
						if (faces != null) {
							...
							for (int i = 0; i < total; i++) {
								...
								//File f = new File("D://captures.png");
								...
								if (isRecFace) {
									...
									if(recogniseCode != -1)
									{
										...
										//To insert namwe into the datbasefgjkal
											...
											try {
												...
												PreparedStatement ps = (PreparedStatement) con.prepareStatement("insert into LogBook values (?,?)");
									...
									cnt=0;
									if(names.equals("Unknown Person!"))
									{
										String fName = "D:\\project\\unknowperson\\unknowperson\\unknowperson\\WebContent\\images\\1.jpg";
										cvSaveImage(fName, temp);
										
										String msg = "http://192.168.0.117:8080/unknowperson/";
									      
									      String no1 = "7020273988";
									                      
									      String requestUrl ="http://trans.masssms.tk/api.php?username=saiinfo&password=12345&sender=SAIINF&sendto=917020273988&message=http://192.168.43.147:8080/unknowperson/Unknown.jsp";
									...
									//	d.browse(new URI("http://localhost:8080/unknowperson/Unknown.jsp") );
										}
	...
	public void setClassifierEye(String name) {
		...
		try {
			...
			// Preload the opencv_objdetect module to work a r 4 o u n d a known bug.
			Loader.load(opencv_objdetect.class);
